...
export default function ContactSection() {
  ...
  return (
    <section id="contacto" className="py-24 bg-section-alt border-t border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-4">
              ...
              <a href="https://wa.me/50671398403?text=Hola%2C%20quiero%20consultar%20sobre%20los%20servicios%20de%20Sinapsis." target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                ...
                <span className="text-foreground/70 group-hover:text-green-600 transition-colors">+506 8888-8888</span>
              </a>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg
                ...
                <span className="text-foreground/70">San José, Costa Rica</span>
              </div>
            </div>
          </div>
