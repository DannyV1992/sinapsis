...
const steps = [
  {
    ...
    description:
      "Una conversación y una evaluación al mismo tiempo. Me contás qué te trae y construimos un mapa claro de tu situación. Al final ya tenés claridad sobre cómo seguir — sin obligación de continuar.",
    what: [
      ...
      "Vemos dudas sobre el proceso, precios y modalidad",
      "Decidimos juntos si tiene sentido continuar",
    ],
    result: "Un plan terapéutico claro y la decisión informada de si iniciar el proceso.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Cada sesión tiene estructura y propósito. No es solo hablar — es identificar qué patrones te frenan, cuestionarlos y practicar alternativas en tu día a día.",
    what: [
  ...
  },
  {
    ...
    description:
      "La terapia no es lineal. Hay semanas de avance y semanas que se sienten como retroceso — eso también es parte del proceso. Revisamos cómo vas y ajustamos. Tu ritmo es válido.",
    what: [
  ...
  },
  {
    ...
    description:
      "El objetivo no es que dependás de la terapia — es que desarrollés la autonomía para manejarte solo. El cierre es planeado y gradual. Podés volver cuando lo necesités; eso no es un fracaso, es inteligencia emocional.",
    what: [
...
function StepCard({ step, index }: { step: (typeof steps)[number]; index: number }) {
  ...
  return (
    ...
    >
      {/* Ícono lateral — solo desktop */}
      <div className="hidden lg:flex flex-shrink-0 flex-col items-center">
        <div className="w-[6.5rem] h-[6.5rem] flex flex-col items-center justify-center bg-white rounded-2xl border border-gray-100 shadow-sm relative z-10">
      ...
      <div className="flex-1 bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 hover:shadow-md transition-shadow">
        <div className="flex items-start justify-between gap-4 mb-4">
          <div>
            <span className="lg:hidden text-xs font-bold text-primary/60 tracking-widest">{step.number}</span>
        ...
        <button
          ...
          aria-expanded={open}
        >
          {open ? "Ocultar detalle" : "¿Qué incluye?"}
          <svg
